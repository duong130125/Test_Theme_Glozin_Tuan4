...
var BlsCreateMapStoreLocation = (function () {
  return {
    ...
    storeInforAction: function (listStore) {
      const listStoresInfor = document.querySelectorAll(
        ".store-infor__items a",
      );
        ...
        items.addEventListener("click", (e) => {
          ...
          if (
            !target
              ...
              .classList.contains("store-active")
          ) {
            ...
            target
              .closest(".store-infor__items")
              .classList.remove("store-active");
          }
          const currentFeature = listStore.features.find(
            (feature) => target.id === `infor-${feature.properties.id}`,
          );
